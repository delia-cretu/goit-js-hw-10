...
var _catApiJsDefault = parcelHelpers.interopDefault(_catApiJs);
...
function getCatsList() {
    ...
    return (0, _catApiJsDefault.default).fetchBreeds().then((breeds)=>{
...
function selectBreed(e) {
    ...
    (0, _catApiJsDefault.default).fetchBreedByID(breed).then((article)=>createMarkup(article)).then((markup)=>showBreedInfo(markup)).catch(onError).finally(()=>{
        loader.classList.add("hidden");
...
},{"slim-select":"lzHUr","notiflix":"5z0Oc","./cat-api.js":"d7YdZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lzHUr":[function(require,module,exports) {
...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_H6y8AbAkM4hhLEApJU2a4mYj2lvf2JQqL6g48faElJfjpsdzsmJ8bIZVrSa1w8IU";
...
function fetchBreedByID(breed) {
    return (0, _axiosDefault.default).get(`/images/search?breed_ids=${breed}`).then((res)=>res.data[0]);
}
module.exports = {
    fetchBreeds,
    fetchBreedByID
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequireabb0")
